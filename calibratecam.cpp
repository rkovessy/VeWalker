...
IplImage* calibratecam::GetThresholdedImage(IplImage* img)
{
...
IplImage* calibratecam::GetBlurredImage(IplImage* img)
{
...
IplImage* calibratecam::GetResizedImage(IplImage* img)
{
...
IplImage* calibratecam::GetDilatedImage(IplImage* img)
{
